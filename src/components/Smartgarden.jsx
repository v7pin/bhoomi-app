...
import { FiSun, FiCloud, FiCloudDrizzle, FiCloudRain, FiCloudSnow, FiCloudLightning, FiCloudOff, FiWind } from 'react-icons/fi';
...
const Smartgarden = () => {
  ...
  const [showFertilizerPrediction, setShowFertilizerPrediction] = useState(false);
  ...
  const handlePredictButtonClick = (predictionType) => {
    hideAllPredictions();

    switch (predictionType) {
      case 'crop':
        setShowCropPrediction(true);
        handleScrollTo(cropPredictionRef);
        break;
      case 'fertilizer':
        setShowFertilizerPrediction(true);
  ...
  return (
    <div className="grid grid-cols-1 gap-4 p-4 h-screen relative">
      ...
      />
      <div className="flex flex-col md:flex-row m-1 rounded-3xl">
        {/* Video Section */}
        <div className="video h-68 w-full md:w-96 relative">
          ...
          <div className="absolute inset-0 flex flex-col items-start justify-center text-white">
            <h2 className="text-5xl font-signature l mb-4 ml-4 md:ml-9 tracking-wide">
              Sow the Seeds of Progress
            </h2>
            <div className="flex space-x-4 ml-4 md:ml-9">
        ...
        {/* Weather Section */}
        <div className="weather h-60 w-full md:w-96 border-2 mt-4 md:mt-0 ml-0 md:ml-3 flex items-start justify-start relative">
      ...
      <div className="cropCard flex flex-col md:flex-row gap-10 items-center justify-center">
        {/* Crop Prediction Card */}
        <div className="max-w-xs bg-white border border-gray-200 rounded-xl shadow-xl dark:bg-gray-800 dark:border-gray-700 hover:shadow-2xl transform hover:scale-105 transition-transform duration-300 mb-4 md:mb-0">
          <a href="#">
          ...
          <div className="p-2">
            ...
            <button
              onClick={() => handlePredictButtonClick('crop')}
        ...
        <div className="max-w-xs bg-white border border-gray-200 rounded-xl shadow-xl dark:bg-gray-800 dark:border-gray-700 hover:shadow-2xl transform hover:scale-105 transition-transform duration-300 mb-4 md:mb-0">
          ...
          <div className="p-2">
            ...
            <button
              onClick={() => handlePredictButtonClick('fertilizer')}
              className="inline-flex items-center px-2 py-1 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Predict Now!
            </button>
        ...
        <div className="max-w-xs bg-white border border-gray-200 rounded-xl shadow-xl dark:bg-gray-800 dark:border-gray-700 hover:shadow-2xl transform hover:scale-105 transition-transform duration-300">
          ...
          <div className="p-2">
            ...
            <button
              onClick={() => handlePredictButtonClick('disease')}
              className="inline-flex items-center px-2 py-1 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Predict Now!
            </button>
