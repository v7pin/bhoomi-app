...
const RegisterPage = () => {
  ...
  const [registrationStatus, setRegistrationStatus] = useState("Registration status will be shown here");
  ...
  return (
    <div className="h-screen flex items-center justify-center">
      ...
      <div className="loginPage flex flex-col md:flex-row overflow-hidden bg-white rounded-lg shadow-md opacity-90">
        ...
        <div className="w-full md:w-1/2 h-max p-8 md:p-12">
          ...
          <form className="form grid gap-4">
            <div className="p-1">
              ...
              <div className="input flex p-2 items-center border rounded-md border-gray-300 mt-2">
                <MdEmail className="mr-3 text-xl md:text-2xl text-gray-400" />
                <input
                  type="text"
                  name="email"
                  id="email"
            ...
            <div className="flex items-center justify-center mt-2">
              <span className="text-red-600 text-xs md:text-sm text-nowrap">{registrationStatus}</span>
            </div>
          </form>
        </div>
        ...
        <div className="w-full md:w-1/2 relative overflow-hidden rounded-lg">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center">
            <h2 className="text-2xl md:text-4xl mb-2">जन्मभूमि से जुड़े रहे </h2>
          </div>
